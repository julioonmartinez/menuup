...
@Component({
  selector: 'app-card-menus-public',
  standalone: true,
  imports: [
    MatCardModule,
    CommonModule,
  ...
  templateUrl: './card-menus-public.component.html',
  styleUrl: './card-menu-public.component.scss'
})
export class CardMenusPublicComponent implements OnInit {
